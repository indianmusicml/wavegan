...
def sample_generator(filepath, window_length=65536, fs=16000):
    """
...
def parse_arguments():
    ...
    parser.add_argument('-model_dir', '--model_dir', dest='model_dir', type=str, help='Path to directory containing trained model file')
